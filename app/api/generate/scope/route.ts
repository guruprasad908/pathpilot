...
export async function POST(req: Request) {
    try {
        ...
        const systemPrompt = `You are a Career Architect. A user wants to learn a topic. Your job is to return 3 to 4 specific, high-value career paths or highly focused niches related to their exact input.
